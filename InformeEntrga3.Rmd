...
nb_cv<-train(precio_categoria ~ .- SalePrice, data=train_set, method="naive_bayes", trControl=control)



#predicciones con validacion cruzada
predicciones_cv<-predict(nb_cv, newdata=test)

#precision con validacion cruzada

accuarcy_cv<-sum(diag(table(test$precio_categoria, predicciones_cv))) /nrow(test)
print(paste("Precision con validacion cruzada:", accuarcy_cv))


#prediccion del modelo original, sin validacion
predicciones_test<-predict(modeloClas, newdata=test)


#precision de modelo original
accuarcy_test<-sum(diag(table(test$precio_categoria, predicciones_test))) /nrow(test)
print(paste("Precision del modelo original:", accuarcy_test))


#diferenica de precision 
